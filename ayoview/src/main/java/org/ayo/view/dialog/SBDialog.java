...
public class SBDialog {
    ...
    private SBDialog(Builder builder) {
        ...
        backgroundColorResourceId = (backgroundColor == INVALID) ? android.R.color.transparent : backgroundColor;
                ...
                decorView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (onDismissListener != null) {
                            onDismissListener.onDismiss(SBDialog.this);
                        }
                    }
                });
            }
        ...
        if (adapter != null && holder instanceof HolderAdapter) {
            ...
            holderAdapter.setOnItemClickListener(new OnHolderListener() {
                ...
                public void onItemClick(Object item, View view, int position) {
                    ...
                    onItemClickListener.onItemClick(SBDialog.this, item, view, position);
                }
            });
        }
        return view;
    ...
    private void setClickListener(View view) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                onClickListener.onClick(SBDialog.this, v);
            }
        });
    }
                    ...
                    case KeyEvent.ACTION_UP:
                        if (keyCode == KeyEvent.KEYCODE_BACK) {
                            if (onBackPressListener != null) {
                                onBackPressListener.onBackPressed(SBDialog.this);
                            }
                            if (isCancelable) {
                                onBackPressed(SBDialog.this);
                            }
                            return true;
                        }
                        break;
     ...
     */
    public void onBackPressed(SBDialog dialogPlus) {
        if (onCancelListener != null) {
            onCancelListener.onCancel(SBDialog.this);
        }
        dismiss();
    }
    ...
    public static class Builder {
        ...
        public SBDialog create() {
            return new SBDialog(this);
        }
    }
    
    ///================================================
    public static SBDialog createDialog(Activity activity, int layoutId, Gravity gravity){
    	 final SBDialog dialog = new Builder(activity)
    ...
    public static SBDialog createDialog(Activity activity, int layoutId){
    	return createDialog(activity, layoutId, Gravity.CENTER);
    }
    
    public static SBDialog createDialog(Activity activity, View contentView, Gravity gravity){
    	final SBDialog dialog = new Builder(activity)
    ...
    public static SBDialog createDialog(Activity activity, View contentView){
    	return createDialog(activity, contentView, Gravity.CENTER);
    }
    
    public static SBDialog createProgressDialog(Activity activity, ProgressStyle progressStyle, Gravity gravity){
    	if(progressStyle == ProgressStyle.progress1){
    		View v = View.inflate(activity, R.layout.dlg_plus_progress, null);
        	ImageView vv = (ImageView) v.findViewById(R.id.iv);
        	vv.setImageResource(R.anim.progress_animation_list);
        	AnimationDrawable ad = (AnimationDrawable) vv.getDrawable();
        	ad.start();
        	return createDialog(activity, v, gravity);
    	}else{
    		View v = View.inflate(activity, R.layout.dlg_plus_progress, null);
        	ImageView vv = (ImageView) v.findViewById(R.id.iv);
        	vv.setImageResource(R.anim.progress_animation_list);
    ...
    public static SBDialog createProgressDialog(Activity activity, ProgressStyle progressStyle){
    	return createProgressDialog(activity, progressStyle, Gravity.CENTER);
    }
