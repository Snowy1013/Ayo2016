...
public class ProgressWheel2 extends View {
	...
	private void parseAttributes(TypedArray a) {
		barWidth = (int) a.getDimension(R.styleable.ProgressWheel2_barWidth, barWidth);

		rimWidth = (int) a.getDimension(R.styleable.ProgressWheel2_rimWidth, rimWidth);

		spinSpeed = (int) a.getDimension(R.styleable.ProgressWheel2_spinSpeed, spinSpeed);

		delayMillis = (int) a.getInteger(R.styleable.ProgressWheel2_delayMillis, delayMillis);
		if (delayMillis < 0) {
			delayMillis = 0;
		}
		...
		barLength = (int) a.getDimension(R.styleable.ProgressWheel2_barLength222, barLength);

		textSize = (int) a.getDimension(R.styleable.ProgressWheel2_textSize, textSize);

		textColor = (int) a.getColor(R.styleable.ProgressWheel2_textColor, textColor);

		// if the text is empty , so ignore it
		if (a.hasValue(R.styleable.ProgressWheel2_text222)) {
			setText(a.getString(R.styleable.ProgressWheel2_text222));
		}

		rimColor = (int) a.getColor(R.styleable.ProgressWheel2_rimColor, rimColor);

		circleColor = (int) a.getColor(R.styleable.ProgressWheel2_circleColor, circleColor);
	...
	public void setProgress(int progress, int max) {
		setProgress((int) (360.0*progress / max));
	}
