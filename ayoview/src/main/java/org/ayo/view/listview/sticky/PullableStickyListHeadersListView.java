package org.ayo.view.listview.sticky;
 ...
 */
public class PullableStickyListHeadersListView extends FrameLayout {

    public interface OnHeaderClickListener {
        void onHeaderClick(PullableStickyListHeadersListView l, View header,
    ...
    public interface OnStickyHeaderOffsetChangedListener {
         ...
         */
        void onStickyHeaderOffsetChanged(PullableStickyListHeadersListView l, View header, int offset);
    }
    ...
    public interface OnStickyHeaderChangedListener {
         ...
         */
        void onStickyHeaderChanged(PullableStickyListHeadersListView l, View header,
                                   int itemPosition, long headerId);

    }

    /* --- Children --- */
    private WrapperPullableViewList mList;
    ...
    public WrapperPullableViewList getWrapperPullableViewList(){
    	return new WrapperPullableViewList(getContext());
    }
    ...
    public PullableStickyListHeadersListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mList = getWrapperPullableViewList();
        // null out divider, dividers are handled by adapter so they look good with headers
        mDivider = mList.getRefreshableView().getDivider();
        mDividerHeight = mList.getRefreshableView().getDividerHeight();
        mList.getRefreshableView().setDivider(null);
        mList.getRefreshableView().setDividerHeight(0);
        ...
        if (attrs != null) {
            ...
            try {
                ...
                mList.getRefreshableView().setCacheColorHint(a
                        .getColor(R.styleable.StickyListHeadersListView_android_cacheColorHint, mList.getRefreshableView().getCacheColorHint()));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                    mList.getRefreshableView().setChoiceMode(a.getInt(R.styleable.StickyListHeadersListView_android_choiceMode,
                            mList.getRefreshableView().getChoiceMode()));
                }
                mList.getRefreshableView().setDrawSelectorOnTop(a.getBoolean(R.styleable.StickyListHeadersListView_android_drawSelectorOnTop, false));
                mList.getRefreshableView().setFastScrollEnabled(a.getBoolean(R.styleable.StickyListHeadersListView_android_fastScrollEnabled,
                        mList.getRefreshableView().isFastScrollEnabled()));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                    mList.getRefreshableView().setFastScrollAlwaysVisible(a.getBoolean(
                            R.styleable.StickyListHeadersListView_android_fastScrollAlwaysVisible,
                            mList.getRefreshableView().isFastScrollAlwaysVisible()));
                }
                ...
                if (a.hasValue(R.styleable.StickyListHeadersListView_android_listSelector)) {
                    mList.getRefreshableView().setSelector(a.getDrawable(R.styleable.StickyListHeadersListView_android_listSelector));
                }

                mList.getRefreshableView().setScrollingCacheEnabled(a.getBoolean(R.styleable.StickyListHeadersListView_android_scrollingCache,
                        mList.getRefreshableView().isScrollingCacheEnabled()));
                ...
                mList.getRefreshableView().setTranscriptMode(a.getInt(R.styleable.StickyListHeadersListView_android_transcriptMode,
        ...
        mList.getRefreshableView().setOnScrollListener(new WrapperListScrollListener());
    ...
    private void updateOrClearHeader(int firstVisiblePosition) {
        ...
        final int headerViewCount = mList.getRefreshableView().getHeaderViewsCount();
        ...
        final boolean isFirstViewBelowTop = doesListHaveChildren
                && mList.getRefreshableView().getFirstVisiblePosition() == 0
            ...
            mHeader.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnHeaderClickListener.onHeaderClick(
                            PullableStickyListHeadersListView.this, mHeader,
    ...
    private class WrapperViewListLifeCycleListener implements WrapperPullableViewList.LifeCycleListener {
    ...
    private class AdapterWrapperHeaderClickHandler implements
        ...
        public void onHeaderClick(View header, int itemPosition, long headerId) {
            mOnHeaderClickListener.onHeaderClick(
                    PullableStickyListHeadersListView.this, header, itemPosition,
                    headerId, false);
        }
    ...
    public ListView getWrappedList() {
        return mList.getRefreshableView();
    }
        ...
        if (l != null) {
            mList.setOnTouchListener(new OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    return l.onTouch(PullableStickyListHeadersListView.this, event);
                }
            });
        } else {
    ...
    public void setOnItemLongClickListener(OnItemLongClickListener listener) {
        mList.getRefreshableView().setOnItemLongClickListener(listener);
    }

    public void addHeaderView(View v, Object data, boolean isSelectable) {
        mList.getRefreshableView().addHeaderView(v, data, isSelectable);
    }

    public void addHeaderView(View v) {
        mList.getRefreshableView().addHeaderView(v);
    }

    public void removeHeaderView(View v) {
        mList.getRefreshableView().removeHeaderView(v);
    }

    public int getHeaderViewsCount() {
        return mList.getRefreshableView().getHeaderViewsCount();
    }
    
    public void addFooterView(View v, Object data, boolean isSelectable) {
        mList.getRefreshableView().addFooterView(v, data, isSelectable);
    }

    public void addFooterView(View v) {
        mList.getRefreshableView().addFooterView(v);
    }

    public void removeFooterView(View v) {
        mList.getRefreshableView().removeFooterView(v);
    }

    public int getFooterViewsCount() {
        return mList.getRefreshableView().getFooterViewsCount();
    }
    ...
    public View getEmptyView() {
        return mList.getRefreshableView().getEmptyView();
    }
    ...
    public void smoothScrollBy(int distance, int duration) {
        if (requireSdkVersion(Build.VERSION_CODES.FROYO)) {
            mList.getRefreshableView().smoothScrollBy(distance, duration);
        }
    }
    ...
    public void smoothScrollByOffset(int offset) {
        if (requireSdkVersion(Build.VERSION_CODES.HONEYCOMB)) {
            mList.getRefreshableView().smoothScrollByOffset(offset);
        }
    }
    ...
    public void smoothScrollToPosition(int position) {
        if (requireSdkVersion(Build.VERSION_CODES.FROYO)) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
                mList.getRefreshableView().smoothScrollToPosition(position);
            } else {
                int offset = mAdapter == null ? 0 : getHeaderOverlap(position);
                offset -= mClippingToPadding ? 0 : mPaddingTop;
                mList.getRefreshableView().smoothScrollToPositionFromTop(position, offset);
            }
        }
    }
    ...
    public void smoothScrollToPosition(int position, int boundPosition) {
        if (requireSdkVersion(Build.VERSION_CODES.FROYO)) {
            mList.getRefreshableView().smoothScrollToPosition(position, boundPosition);
        }
    }
    ...
    public void smoothScrollToPositionFromTop(int position, int offset,
        ...
        if (requireSdkVersion(Build.VERSION_CODES.HONEYCOMB)) {
            offset += mAdapter == null ? 0 : getHeaderOverlap(position);
            offset -= mClippingToPadding ? 0 : mPaddingTop;
            mList.getRefreshableView().smoothScrollToPositionFromTop(position, offset, duration);
        }
    }
    ...
    public void setSelectionAfterHeaderView() {
        mList.getRefreshableView().setSelectionAfterHeaderView();
    }

    public void setSelectionFromTop(int position, int y) {
        y += mAdapter == null ? 0 : getHeaderOverlap(position);
        y -= mClippingToPadding ? 0 : mPaddingTop;
        mList.getRefreshableView().setSelectionFromTop(position, y);
    }

    public void setSelector(Drawable sel) {
        mList.getRefreshableView().setSelector(sel);
    }

    public void setSelector(int resID) {
        mList.getRefreshableView().setSelector(resID);
    }

    public int getFirstVisiblePosition() {
        return mList.getRefreshableView().getFirstVisiblePosition();
    }

    public int getLastVisiblePosition() {
        return mList.getRefreshableView().getLastVisiblePosition();
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public void setChoiceMode(int choiceMode) {
        mList.getRefreshableView().setChoiceMode(choiceMode);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public void setItemChecked(int position, boolean value) {
        mList.getRefreshableView().setItemChecked(position, value);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public int getCheckedItemCount() {
        if (requireSdkVersion(Build.VERSION_CODES.HONEYCOMB)) {
            return mList.getRefreshableView().getCheckedItemCount();
        }
        return 0;
    }
    ...
    public long[] getCheckedItemIds() {
        if (requireSdkVersion(Build.VERSION_CODES.FROYO)) {
            return mList.getRefreshableView().getCheckedItemIds();
        }
        return null;
    }
    ...
    public int getCheckedItemPosition() {
        return mList.getRefreshableView().getCheckedItemPosition();
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public SparseBooleanArray getCheckedItemPositions() {
        return mList.getRefreshableView().getCheckedItemPositions();
    }

    public int getCount() {
        return mList.getRefreshableView().getCount();
    }

    public Object getItemAtPosition(int position) {
        return mList.getRefreshableView().getItemAtPosition(position);
    }

    public long getItemIdAtPosition(int position) {
        return mList.getRefreshableView().getItemIdAtPosition(position);
    }
    ...
    public void setFastScrollEnabled(boolean fastScrollEnabled) {
        mList.getRefreshableView().setFastScrollEnabled(fastScrollEnabled);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public void setFastScrollAlwaysVisible(boolean alwaysVisible) {
        if (requireSdkVersion(Build.VERSION_CODES.HONEYCOMB)) {
            mList.getRefreshableView().setFastScrollAlwaysVisible(alwaysVisible);
        }
    }
    ...
    public boolean isFastScrollAlwaysVisible() {
        ...
        return mList.getRefreshableView().isFastScrollAlwaysVisible();
    }
    ...
    public int getPositionForView(View view) {
        return mList.getRefreshableView().getPositionForView(view);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public void setMultiChoiceModeListener(MultiChoiceModeListener listener) {
        if (requireSdkVersion(Build.VERSION_CODES.HONEYCOMB)) {
            mList.getRefreshableView().setMultiChoiceModeListener(listener);
        }
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        return mList.getRefreshableView().onSaveInstanceState();
    }

    @Override
    public void onRestoreInstanceState(Parcelable state) {
        super.onRestoreInstanceState(BaseSavedState.EMPTY_STATE);
        mList.getRefreshableView().onRestoreInstanceState(state);
    }
    ...
    public void setTranscriptMode (int mode) {
        mList.getRefreshableView().setTranscriptMode(mode);
    }
