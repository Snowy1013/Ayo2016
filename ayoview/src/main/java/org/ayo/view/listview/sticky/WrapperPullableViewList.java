...
public class WrapperPullableViewList extends PullToRefreshListView {

	public WrapperPullableViewList(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	
	public WrapperPullableViewList(Context context) {
		super(context);
		init();
...
//	}
	...
	int getFixedFirstVisibleItem() {
		int firstVisibleItem = getRefreshableView().getFirstVisiblePosition();
