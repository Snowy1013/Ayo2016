...
import org.ayo.view.listview.sticky.WrapperViewList.LifeCycleListener;
 ...
 */
public class StickyListHeadersListView2 extends FrameLayout {

    public interface OnHeaderClickListener {
        void onHeaderClick(StickyListHeadersListView2 l, View header,
    ...
    public interface OnStickyHeaderOffsetChangedListener {
         ...
         */
        void onStickyHeaderOffsetChanged(StickyListHeadersListView2 l, View header, int offset);
    }
    ...
    public interface OnStickyHeaderChangedListener {
         ...
         */
        void onStickyHeaderChanged(StickyListHeadersListView2 l, View header,
    ...
    public StickyListHeadersListView2(Context context) {
        this(context, null);
    }

    public StickyListHeadersListView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public StickyListHeadersListView2(Context context, AttributeSet attrs, int defStyle) {
            ...
            mHeader.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnHeaderClickListener.onHeaderClick(
                            StickyListHeadersListView2.this, mHeader,
    ...
    private class AdapterWrapperHeaderClickHandler implements
        ...
        public void onHeaderClick(View header, int itemPosition, long headerId) {
            mOnHeaderClickListener.onHeaderClick(
                    StickyListHeadersListView2.this, header, itemPosition,
                    headerId, false);
        }
        ...
        if (l != null) {
            mList.setOnTouchListener(new OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    return l.onTouch(StickyListHeadersListView2.this, event);
                }
            });
        } else {
