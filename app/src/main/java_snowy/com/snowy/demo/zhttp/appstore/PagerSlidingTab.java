...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF5fa9ed;
	private int indicatorHeight = 4;

	private int tabTextSize = 16;
	private int tabTextColor = 0xFF8D8400;
	...
	private int underlineColor = 0x1AF8F8F8;
	...
	public PagerSlidingTab(Context context, AttributeSet attrs, int defStyle) {
		...
		tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTab_tabBackgroundResId, tabBackgroundResId);
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				tab.setTextColor(i==0?tabTextColor:0xff818181);
				tab.setTextAppearance(getContext(),R.style.VariableValue);
		...
		public void onPageSelected(int position) {
			...
			for (int i = 0; i < tabCount; i++) {
				...
				if(v instanceof TextView){
					...
					textView.setTextColor(i==pager.getCurrentItem()?tabTextColor:0xff818181);
				}
			}
		}
	}
