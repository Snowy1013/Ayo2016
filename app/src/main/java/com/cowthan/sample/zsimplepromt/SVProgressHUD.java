...
public class SVProgressHUD {
    ...
    protected void initViews() {
        ...
        rootView = (ViewGroup) layoutInflater.inflate(R.layout.sv_layout_svprogresshud, null, false);
    ...
    private void setMaskType(SVProgressHUDMaskType maskType) {
        ...
        switch (mSVProgressHUDMaskType) {
            ...
            case ClearCancel:
                ...
                break;
            case Black:
                configMaskType(R.color.sv_bgColor_overlay, true, false);
                break;
            case BlackCancel:
                configMaskType(R.color.sv_bgColor_overlay, true, true);
                break;
            case Gradient:
                //TODO 设置半透明渐变背景
                configMaskType(R.drawable.sv_bg_overlay_gradient, true, false);
                break;
            case GradientCancel:
                //TODO 设置半透明渐变背景
                configMaskType(R.drawable.sv_bg_overlay_gradient, true, true);
                break;
            default:
                break;
        }
