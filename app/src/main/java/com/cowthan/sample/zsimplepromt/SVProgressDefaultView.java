...
public class SVProgressDefaultView extends LinearLayout {
    private int resBigLoading = R.mipmap.sv_ic_svstatus_loading;
    private int resInfo = R.mipmap.sv_ic_svstatus_info;
    private int resSuccess = R.mipmap.sv_ic_svstatus_success;
    private int resError = R.mipmap.sv_ic_svstatus_error;
    ...
    private void initViews() {
        LayoutInflater.from(getContext()).inflate(R.layout.sv_view_svprogressdefault, this, true);
