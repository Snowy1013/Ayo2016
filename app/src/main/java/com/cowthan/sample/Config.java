...
import com.cowthan.sample.zbutton.ButtonDemoActivity;
import com.cowthan.sample.zdatabase.XUtilsDBDemoActivity;
import com.cowthan.sample.zeventbus.EventBusDemoActivity;
import com.cowthan.sample.zfragment.FragmentDemoActivity;
import com.cowthan.sample.zglass_broken.GlassBrokenMainActivity;
import com.cowthan.sample.ziosmessage_list.IosMessageMainActivity;
import com.cowthan.sample.zlayout.LayoutDemoActivity;
import com.cowthan.sample.zlikeview.LikeViewMainActivity;
import com.cowthan.sample.zlikeview2.LikeView2MainActivity;
import com.cowthan.sample.zmathview.MathViewMainActivity;
import com.cowthan.sample.zpartial_explode.PartialExplodeMainActivity;
import com.cowthan.sample.zsdk.ToolkitSampleActivity;
import com.cowthan.sample.zsimplepromt.SvProgressHudDemoActivity;
import com.cowthan.sample.ztextview.TextViewDemoActivity;
import com.cowthan.sample.ztmpl_listview.TmplListActivity;
import com.cowthan.sample.zviewpager.ViewPagerDemoActivity;
    ...
    private void init(){
        ...
        menus.add(m1);
        {
            ...
            m1.addMenuItem(menuItem1);
            {
                ...
                menuItem1.addLeaf(new Leaf("崩溃日志", "", null));
