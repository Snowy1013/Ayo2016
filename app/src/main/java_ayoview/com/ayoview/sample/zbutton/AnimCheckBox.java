...
public class AnimCheckBox extends View {
    ...
    private void init(AttributeSet attrs){
        if (attrs != null){
            ...
            mStrokeWidth = (int)array.getDimension(R.styleable.AnimCheckBox_animcheckbox_stroke_width, dip(mStrokeWidth));
            mStrokeColor = array.getColor(R.styleable.AnimCheckBox_animcheckbox_stroke_color, mStrokeColor);
            mCircleColor = array.getColor(R.styleable.AnimCheckBox_animcheckbox_circle_color, mCircleColor);
            array.recycle();
        }else {
