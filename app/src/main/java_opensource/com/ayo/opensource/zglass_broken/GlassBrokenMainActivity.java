package com.ayo.opensource.zglass_broken;
...
public class GlassBrokenMainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.glass_broken_ac_main);
    ...
    private void initView(){
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getActivity(),"Button onClick",Toast.LENGTH_SHORT).show();
            }
        });
...
//    }
    ...
    public void refreshDate(){
        ...
        listView.setAdapter(new SampleAdapter(getActivity(), android.R.layout.simple_list_item_1, items));
...
//        getMenuInflater().inflate(R.menu.glass_broken_main_menu, menu);
//        return true;
//    }
